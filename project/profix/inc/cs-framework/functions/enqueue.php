...
if( ! function_exists( 'cs_admin_enqueue_scripts' ) ) {
  function cs_admin_enqueue_scripts() {
    ...
    // framework core styles
	  wp_enqueue_style( 'profix', CS_URI .'/assets/css/cs-framework.css', array(), '1.0.0', 'all' );
	  wp_enqueue_style( 'pe-icon-7-stroke', CS_URI .'/assets/css/pe-icon-7-stroke.css', array(), '1.2.0', 'all' );
	  wp_enqueue_style( 'et-line', CS_URI .'/assets/css/et-line.css', array(), '1.0.1', 'all' );
    ...
    wp_enqueue_script( 'profix',  CS_URI .'/assets/js/cs-framework.js',  array( 'cs-plugins' ), '1.0.0', true );
