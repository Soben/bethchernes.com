...
vc_map(
	array(
		"name" => esc_html__( "Profi Testimonials Section", "profi-toolkit" ),
		"base" => "profi_testimonials",
		...
		"params" => array(
			...
			array(
				...
				"std" => esc_html__( "Testimonial.", "profi-toolkit" ),
			...
			array(
				...
				"std" => esc_html__( "Client says about me", "profi-toolkit" ),
			...
			array(
				"type" => "textfield",
				"heading" => esc_html__( "Testimonials Count", "profi-toolkit" ),
				"param_name" => "count",
				"value" => esc_html__( "-1", "profi-toolkit" ),
				"description" => esc_html__( "Type testimonials count number, how much you want to show (-1 for unlimited testimonials).", "profi-toolkit" )
			),
			array(
				"type" => "dropdown",
