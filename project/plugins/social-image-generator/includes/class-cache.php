...
class Cache {
    ...
    public static function create() {
        $cache_cleanup_recurrence = apply_filters('social_image_generator_cache_cleanup_recurrence', 'daily');
     ...
     */
    public static function flush_by_id($post_id) {
    ...
    public static function flush($force = false) {
        $max_age = apply_filters('social_image_generator_cache_files_max_age', WEEK_IN_SECONDS);
        $success = true;
     ...
     * @return string
     */
    private static function get_filename_by_id($id) {
        return md5(SOCIAL_IMAGE_GENERATOR_SLUG . ':' . intval($id)) . '.png';
    }
